...
@keyframes shake {
  ...
  100% { transform: translateX(-50%) rotate(2deg); }
    ...
    LoadModel_(characterName = 'Knight_Male') { // 기본값으로 Knight_Male 설정
      ...
      loader.load(`${characterName}.gltf`, (gltf) => {
        ...
        for (const clip of gltf.animations) {
          ...
          loadedAnimations.push(clip.name);
        }
        console.log(`[Player] Loaded animations for ${characterName}:`, loadedAnimations);
    ...
    SetAnimation_(name) {
      ...
      console.log(`[Player] SetAnimation_ called: ${name} (current: ${this.currentAnimationName_})`);
      console.log(`[Player] Available animations:`, Object.keys(this.animations_));
